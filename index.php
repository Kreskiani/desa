...
<html lang="en" >
  <head>
    ...
    <title>Portal Pertama Aplikasi Desa</title>
	<!--Core CSS -->
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<!-- About text start -->
							<div class="section-title">
								<h2 style="color: #FFF;">Selamat datang di Aplikasi Desa</h2>
								<p>Portal pertama sebelum memilih pilihan web desa.</p>
							</div>
						<!-- About text end -->	
						</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
									<div class="welcome_part wow fadeInLeft">
										<div class="welcome_icon">
											<i class="fa  fa-4x"><a href="<?php echo $base_url_simkudes ?>"><img src="images/uang_putih.png" style="width:100%"></a></i>
										</div>
										<h2>SIMKUDES</h2>
										<p>Sistem Keuangan Desa ( SIMKUDES ). Webpage berisi seluruh pengelolaan keuangan untuk desa. </p>
									</div>
								</div>
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
								<div class="welcome_part wow fadeInUp">
									<div class="welcome_icon">
										<a href="<?php echo $base_url_simades ?>">
											<i class="fa fa-4x">
												<img src="images/message_putih.png" style="width:100%">
											</i>
										</a>
									</div>
									<h2>SIMADES</h2>
									<p>Sistem Managemen Desa ( SIMADES ). Webpage berisi seluruh sistem surat menyurat administrasi desa. </p>
								</div>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
								<div class="welcome_part wow fadeInDown">
									<div class="welcome_icon">
										<a href="<?php echo $base_url_prodes ?>">
											<i class="fa fa-4x">
												<img src="images/panah_putih.png" style="width:100%">
											</i>
										</a>
									</div>
									<h2>PROMODES</h2>
									<p>Profil dan Monografi Desa ( PROMODES ). Webpage berisi tentang seluruh profil desa mulai dari sejarah sampai isi penduduknya. </p>
								</div>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
									...
									<div class="container-fluid">
										...
										<div id="menu-center">
											<ul class="nav navbar-nav navbar-right mainnav">
												<li><a href="#header_part" >Portal</a></li>
